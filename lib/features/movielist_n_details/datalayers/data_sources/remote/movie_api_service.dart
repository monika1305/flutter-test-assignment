...
abstract class MovieApiService {
  ...
  @GET('/')
  Future<HttpResponse<MovieModel>> getDetailMovieById(String detailsMovie);

  // GET /3/tv/series_id/videos?language=en-US HTTP/1.1
  // Accept: application/json
  // Authorization: Bearer e80b35c79c9aeecc88d02db8c7437f9e
  // Host: api.themoviedb.org
  //
  @GET('/')
  Future<HttpResponse<MovieModel>> getDetailsMovieVideo(String detailsMovieVideos);
